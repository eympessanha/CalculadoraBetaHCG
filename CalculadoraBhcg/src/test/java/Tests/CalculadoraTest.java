...
class CalculadoraTest {
    ...
    public void testForaDoIntervaloAcimaDe16Semanas() {
        assertEquals("Fora do intervalo de 3–16 semanas de gestação.", calc.interpretarBhcg(100, 119));
    }

    @Test
    public void testSemana3() {
        int dum = 21;
        assertEquals("Resultado negativo. Pode ser falso negativo nesta fase precoce (<4 sem). Repetir exame em 1 semana", calc.interpretarBhcg(4.9, dum));
        assertEquals("Resultado positivo compatível com a idade gestacional", calc.interpretarBhcg(26, dum));
    ...
    public void testSemana4() {
        int dum = 28;
        assertEquals("Resultado negativo", calc.interpretarBhcg(9.9, dum));
        assertEquals("Resultado positivo compatível com a idade gestacional", calc.interpretarBhcg(27, dum));
